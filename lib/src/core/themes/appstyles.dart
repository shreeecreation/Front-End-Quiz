...
abstract class AppStyles {
  ...
  // text 24px
  //regular
  static TextStyle text26Px = GoogleFonts.openSans(
    fontSize: 24.sp,
    height: calculateHeight(28, 24),
    fontStyle: FontStyle.normal,
  );
  ...
  //medium
  static TextStyle text26PxMedium = GoogleFonts.openSans(
    fontSize: 26.sp,
    fontWeight: FontWeight.w500,
    height: calculateHeight(28, 24),
    fontStyle: FontStyle.normal,
  ...
  //SemiBold
  static TextStyle text26PxSemiBold = GoogleFonts.openSans(
    fontSize: 26.sp,
    fontWeight: FontWeight.w600,
    height: calculateHeight(28, 24),
    fontStyle: FontStyle.normal,
  ...
  //bold
  static TextStyle text26PxBold = GoogleFonts.openSans(
    fontSize: 26.sp,
    fontWeight: FontWeight.bold,
    height: calculateHeight(28, 24),
    fontStyle: FontStyle.normal,
